...
#ifdef DIRECT_ACCESS_LINK
#define READ_GAUGE_MATRIX READ_GAUGE_MATRIX_12_FLOAT4_STR
#else
...
#endif
#define READ_SPINOR_GLOBAL READ_SPINOR
...
#define READ_SPINOR_UP READ_SPINOR_SINGLE_UP_GLOBAL
#define READ_SPINOR_DOWN READ_SPINOR_SINGLE_DOWN_GLOBAL
#define READ_SPINOR_GLOBAL READ_SPINOR_SINGLE_GLOBAL
#define SPINORTEX in
#else
#define READ_SPINOR READ_SPINOR_SINGLE_TEX
#define READ_SPINOR_UP READ_SPINOR_SINGLE_UP_TEX
#define READ_SPINOR_DOWN READ_SPINOR_SINGLE_DOWN_TEX
#define READ_SPINOR_GLOBAL READ_SPINOR_SINGLE_TEX
