...
#define WRITE_SPINOR_SHORT4_STR(stride)					\
  ...
  o22_re *= scale; o22_im *= scale; o30_re *= scale; o30_im *= scale;	\
  o31_re *= scale; o31_im *= scale; o32_re *= scale; o32_im *= scale;	\
  store_streaming_float4(&out[0*(stride)+sid], (short)o00_re, (short)o00_im, (short)o01_re, (short)o01_im); \
  store_streaming_float4(&out[1*(stride)+sid], (short)o02_re, (short)o02_im, (short)o10_re, (short)o10_im); \
  store_streaming_float4(&out[2*(stride)+sid], (short)o11_re, (short)o11_im, (short)o12_re, (short)o12_im); \
...
#define WRITE_ST_SPINOR_FLOAT2_STR()					\
  store_streaming_float2(&g_out[0*sp_stride+sid], o00_re, o00_im);	\
  store_streaming_float2(&g_out[1*sp_stride+sid], o01_re, o01_im);	\
  store_streaming_float2(&g_out[2*sp_stride+sid], o02_re, o02_im);	

#define WRITE_ST_SPINOR_SHORT2_STR()					\
  float c0 = fmaxf(fabsf(o00_re), fabsf(o00_im));			\
  float c1 = fmaxf(fabsf(o01_re), fabsf(o01_im));			\
  float c2 = fmaxf(fabsf(o02_re), fabsf(o02_im));			\
  c0 = fmaxf(c0, c1);							\
