#ifndef _UNITARIZE_UTILITIES_H_
#define _UNITARIZE_UTILITIES_H_

#include <cstdlib>
#include <cuda.h>


// Complex and Link variable classes 
// used in the HISQ unitarization routines,
// and some elementary operations on these classes.
namespace hisq {
