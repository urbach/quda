...
void DiracWilson::Dslash(cudaColorSpinorField &out, cudaColorSpinorField &in, 
...
void DiracWilson::DslashXpay(cudaColorSpinorField &out, cudaColorSpinorField &in, 
			     const int parity, const QudaDagType dagger,
...
void DiracWilson::M(cudaColorSpinorField &out, cudaColorSpinorField &in, const QudaDagType dagger) {
  checkFullSpinor(out, in);
  DslashXpay(out.Odd(), in.Even(), 1, dagger, in.Odd(), -kappa);
  DslashXpay(out.Even(), in.Odd(), 0, dagger, in.Even(), -kappa);
}

void DiracWilson::MdagM(cudaColorSpinorField &out, cudaColorSpinorField &in) {
  checkFullSpinor(out, in);
...
void DiracWilsonPC::M(cudaColorSpinorField &out, cudaColorSpinorField &in, 
...
void DiracWilsonPC::MdagM(cudaColorSpinorField &out, cudaColorSpinorField &in){
