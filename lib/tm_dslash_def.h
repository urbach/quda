...
#if (DD_PREC == 0)
#define DD_PARAM4 const double a, const double b, const double2 *x, const float *xNorm, const LatticeParam lp, const DslashParam dp
#elif (DD_PREC == 1) 
#define DD_PARAM4 const float a, const float b, const float4 *x, const float *xNorm, const LatticeParam lp, const DslashParam dp
#else
#define DD_PARAM4 const float a, const float b, const short4 *x, const float *xNorm, const LatticeParam lp, const DslashParam dp
#endif
