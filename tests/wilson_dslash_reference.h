...
extern "C" {
  ...
  void tm_ndeg_mat(void *out1, void* out2, void **gauge, void *in1, void *in2,  double kappa, double mu, 
	         double epsilon, int dagger_bit, QudaPrecision precision, QudaGaugeParam &param);	      
  ...
  void tm_ndeg_matpc(void *outEven1, void *outEven2, void **gauge, void *inEven1, void *inEven2, double kappa, double mu, double epsilon,
	             QudaMatPCType matpc_type, int dagger_bit, QudaPrecision precision, QudaGaugeParam &param);
