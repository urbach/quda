...
extern int
neighborIndex(int i, int oddBit, int dx4, int dx3, int dx2, int dx1) {
...
void staggered_dslash(void *res, void **fatlink, void** longlink,
		      void *spinorField, int oddBit, int daggerBit,
