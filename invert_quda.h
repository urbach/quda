...
extern "C" {
  ...
  // Interface functions
    ...
    void loadGaugeQuda_st(void *h_gauge, QudaGaugeParam *param, void* cudaLinkPrecise, void* cudaLinkSloppy);
    void loadFatGaugeQuda(void *h_gauge, QudaGaugeParam *param, void* cudaLinkPrecise, void* cudaLinkSloppy);
    
    void invertQuda(void *h_x, void *h_b, QudaInvertParam *param);
    int invertQuda_milc(void *h_x, void *h_b, QudaInvertParam *param, double mass, QudaParity parity);
    int invertQuda_milc_multi_offset(void **h_x, void *h_b, QudaInvertParam *param,
