...
static ParityHw 
allocateParityHw(int *X, Precision precision) 
{
    ParityHw ret;
...
FullHw 
createHwQuda(int *X, Precision precision) 
{
    FullHw ret;
...
void
static loadParityHw(ParityHw ret, void *hw, Precision cpu_prec)
{
    void *packedHw1 = 0;
...
void
loadHwToGPU(FullHw ret, void *hw, Precision cpu_prec)
{
    void *hw_odd;
...
static void 
retrieveParityHw(void *res, ParityHw hw, Precision cpu_prec)
{
    void *packedHw1 = 0;
...
void 
retrieveHwField(void *res, FullHw hw, Precision cpu_prec)
{
    void *res_odd;
