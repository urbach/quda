...
class Dirac {
 ...
 public:
  ...
  virtual void Dslash(cudaColorSpinorField &out, cudaColorSpinorField &in, 
		      const int parity, const QudaDagType) = 0;
  virtual void DslashXpay(cudaColorSpinorField &out, cudaColorSpinorField &in, 
			  const int parity, const QudaDagType,
			  const cudaColorSpinorField &x, const double &k) = 0;
  virtual void M(cudaColorSpinorField &out, cudaColorSpinorField &in, 
		 const QudaDagType = QUDA_DAG_NO) = 0;
  virtual void MdagM(cudaColorSpinorField &out, cudaColorSpinorField &in) = 0;
...
class DiracWilson : public Dirac {
 ...
 public:
  ...
  virtual void M(cudaColorSpinorField &out, cudaColorSpinorField &in, const QudaDagType = QUDA_DAG_NO);
  virtual void MdagM(cudaColorSpinorField &out,  cudaColorSpinorField &in);
...
class DiracWilsonPC : public DiracWilson {
 ...
 public:
  ...
  void M(cudaColorSpinorField &out, cudaColorSpinorField &in, const QudaDagType = QUDA_DAG_NO);
  void MdagM(cudaColorSpinorField &out, cudaColorSpinorField &in);
...
class DiracClover : public DiracWilson {
 ...
 protected:
  ...
  void checkParitySpinor(const cudaColorSpinorField &, const cudaColorSpinorField &, 
			 const FullClover &);
  void cloverApply(cudaColorSpinorField &out, const FullClover &clover, cudaColorSpinorField &in, 
		   const int parity);
 ...
 public:
  ...
  void Clover(cudaColorSpinorField &out, cudaColorSpinorField &in, const int parity);
  virtual void M(cudaColorSpinorField &out, cudaColorSpinorField &in, const QudaDagType = QUDA_DAG_NO);
  virtual void MdagM(cudaColorSpinorField &out, cudaColorSpinorField &in);
...
class DiracCloverPC : public DiracClover {
 ...
 public:
  ...
  void CloverInv(cudaColorSpinorField &out, cudaColorSpinorField &in, const int parity);  
  void Dslash(cudaColorSpinorField &out, cudaColorSpinorField &in, 
	      const int parity, const QudaDagType);
  void DslashXpay(cudaColorSpinorField &out, cudaColorSpinorField &in, 
		  const int parity, const QudaDagType,
		  const cudaColorSpinorField &x, const double &k);
